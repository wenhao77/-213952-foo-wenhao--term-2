...
$score2= "0";
 ?>
<script>
    var memory_array = ['A','A','B','B','C','C','D','D','E','E','F','F','I','I','J','J','K','K','L','L','M','M','N','N',
                        'O','O','P','P','Q','Q','R','R',
    ...
    if (memory_value.length == 0) {
      ...
      if (memory_value[0] == memory_value[1]) {
        ...
        if (tiles_flipped == memory_array.length) {
          alert("you've matched them all good job")
          document.getElementById('board').innerHTML= "";
          location.href = 'http://wenhaoportal.hopto.org/memory%20game/2player64.php';
          }
        }
      }
    }
